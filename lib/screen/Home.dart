          ...
          Positioned(
            ...
            child: Column(
              children: [
                Spacer(),
                Container(
                  height: global.getHeight(context) / 1.7,
                    ...
                    child: Column(
                      children: [
                        ...
                        widget.getWidgetMenu2(
                          context: context,
                          routeName: "/mainPenerimaan",
                          title: "Penerimaan Barang Urugan",
                          color: defBlue,
                          colorIcon: defBlue,
                          menuCode: "penerimaanbarangproyek",
                          image: AssetImage("assets/urugan.png"),
                        ),
                        widget.getWidgetMenu2(
                          context: context,
                        ...
                        widget.getWidgetMenu2(
                          context: context,
                          routeName: "/cancelTransaksi",
                          title: "Batal Transaksi",
                          color: defWhite,
                          colorIcon: defBlue,
                          menuCode: "bataltransaksi",
