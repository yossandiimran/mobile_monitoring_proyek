...
class ReverseTransaksi extends StatefulWidget {
  final objParam;
  const ReverseTransaksi({this.objParam});
  @override
  ReverseTransaksiState createState() => ReverseTransaksiState(objParam);
}

class ReverseTransaksiState extends State<ReverseTransaksi> {
  final objParam;
  ...
  ReverseTransaksiState(this.objParam);
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: Text("  Nomor PO :", textAlign: TextAlign.left),
                          ),
                          Container(
                                ...
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Spacer(),
                                        Text("Reverse ", style: textStyling.styleText5(14, defWhite)),
  ...
  sendService() async {
    ...
    Map objParam = {"nomer_po": noDoc.text, "keterangan": keterangan.text};

    var res = await TransaksiService(context: context, objParam: objParam).reverseNoDoc();

    if (res != null) {
      Navigator.pop(context);
      global.successResponsePop(context, "PO Berhasil Dibatalkan !");
    }
  }
}
